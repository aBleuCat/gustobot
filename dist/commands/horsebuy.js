...
export default {
    data: new SlashCommandBuilder()
        ...
        .addIntegerOption(o => o.setName('count').setDescription('How many to buy').setRequired(false).setMinValue(1).setMaxValue(maxAmount)),
    async execute(interaction) {
        ...
        await interaction.editReply(`You bought ${count > 1 ? `**${count}x** ` : 'a '}**${name}** for **${totalCost}** 🪙 Horse Coin${totalCost !== 1 ? 's' : ''}\nBalance: **${inventory.horseCoins}** 🪙`);
    },
};
//# sourceMappingURL=horsebuy.js.map