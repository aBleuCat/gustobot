...
export default {
    ...
    async execute(interaction) {
        ...
        if (!stats || !stats.lastTimestamp) {
            await interaction.reply('No lols have been recorded in the database yet!');
        }
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields({ name: 'Today', value: `${stats.daily}`, inline: true }, { name: 'This Week', value: `${stats.weekly}`, inline: true }, { name: 'All Time', value: `${stats.allTime}`, inline: true }, { name: 'Last Lol', value: `${discordTime} (${relativeTime})`, inline: false });
