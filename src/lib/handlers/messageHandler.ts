  ...
  client.on(Events.MessageCreate, async msg => {
    ...
    if (canUsePrimary) {
      try {
        ...
        console.error('Primary trigger error', (e as Error).message);
        devLog(`Primary trigger error: ${(e as Error).message}`);
      }
    }
    ...
    if (canUseSecondary) {
      try {
        ...
        console.error('Secondary trigger error', (e as Error).message);
        devLog(`Secondary trigger error: ${(e as Error).message}`);
      }
    }
    ...
    try {
      ...
      console.error('Autorole trigger error', (e as Error).message);
      devLog(`Autorole trigger error: ${(e as Error).message}`);
    }
  });
}
