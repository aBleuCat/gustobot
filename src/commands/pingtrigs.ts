...
export default {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand((sub: any) => sub
            ...
            .addStringOption((o: any) => o.setName('trigger').setDescription('Trigger word/phrase').setRequired(true))
            .addStringOption((o: any) => o.setName('response').setDescription('Bot response').setRequired(true))
        ...
        .addSubcommand((sub: any) => sub
            ...
            .addStringOption((o: any) => o.setName('id').setDescription('Trigger ID').setRequired(true))),
    ...
    async execute(interaction: ChatInputCommandInteraction): Promise<void> {
        ...
        if (sub === 'add') {
            ...
            if (!triggers.length) await interaction.reply('No triggers setup');
            const list = triggers.map((t: any) => `**${t._id}**: ${t.trigger} (${t.type}) → ${t.response}`).join('\n');
