...
export default {
    data: new SlashCommandBuilder()
        ...
        .addUserOption((o: any) => o.setName('target').setDescription('Who to give coins to').setRequired(true))
        .addIntegerOption((o: any) => o.setName('amount').setDescription('How many coins to give').setRequired(true).setMinValue(1)),
