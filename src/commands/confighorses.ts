...
export default {
    data: new SlashCommandBuilder()
        ...
        .addBooleanOption((o: any) => o.setName('enabled').setDescription('Enable or disable spawning').setRequired(true))
        .addChannelOption((o: any) => o.setName('channel').setDescription('The channel where horse spawns are announced').setRequired(true))
