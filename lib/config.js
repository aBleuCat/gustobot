...
const config = {
    // horseSpawner.js
    DEBOUNCE_MS: 1, // was 2000 before
    SIMILARITY_THRESHOLD: 1.00, // was 0.70 before
    RECENT_MSG_COUNT: 5,
    COIN_CHANCE: 1, // used to be 4 // spawns per horse instead of per message
    SPAWN_COEFFICIENT: 5, // used to be 15
    FLAIR_THRESHOLD_VALUE: 1, // used to be 100
    COIN_DROP_SIZE: 4,
    COIN_DROP_MIN: 20, // used to be 3
    COIN_DROP_MAX: 100, // used to be 10
    ANTIINFLATOR: antiinflator,

    // chatTriggers / randomCat
    UNEXPECTED_CAT_PROBABILITY: 1000,
    MIN_CYCLE_COIN_COUNT: -1000000000000, // used to be -5

    // horsegamble.js
    FRENZY_THRESHOLD_MS: 10 * 60 * 1000,
    FRENZY_CHANCE: 0.20,
    CONFISCATE_CHANCE: 0, // used to be 0.25
    LOSS_THRESHOLD: -200, // used to be -75
    ...
    COMMON_BUY_PRICE: 1, // used to be 8
    COMMON_SELL_PRICE: 10, // used to be 2
...
const descriptions = {
    ...
    RULE_CACHE_TTL_MS:         'How long to cache autorole rules in memory to avoid DB hits every message (in ms)',
};
